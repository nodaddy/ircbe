...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    my_applications = models.CharField(_('my_Applications'), default='~', max_length=1000000, null=True)
    my_accepted = models.CharField(_('my_Accepted'), default='~', max_length=1000000, null=True)
    my_bookmarks = models.CharField(_('my_Bookmarks'), max_length=1000000, default='~', null=True)
